...
#@title GRBM Model definition (potentially) with symmetries { form-width: "400px" }

# Load RBM Pytorch implementation
from RBM_pytorch.rbm_GRBM import GRBM
# from RBM_pytorch.rbm_1 import RBM

myRBM = GRBM(num_visible = df_train.shape[1],
...
torch.save(myRBM, 'model_symm_36_cells_sun_GRBM_300_epochs_lr_0002_50_mcmc_steps_3_4_data.pt')
